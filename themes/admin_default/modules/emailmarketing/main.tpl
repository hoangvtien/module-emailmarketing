    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover table-middle">
            ...
            <tbody>
                <!-- BEGIN: loop -->
                <tr>
                    <td rowspan="2" class="text-center"><input type="checkbox" onclick="nv_UncheckAll(this.form, 'idcheck[]', 'check_all[]', this.checked);" value="{VIEW.id}" name="idcheck[]" class="post"></td>
                    ...
                    <td class="text-center">
                        <!-- BEGIN: update --> <i class="fa fa-play fa-lg">&nbsp;</i><a href="{VIEW.link_statics}">{LANG.sends}</a> - <i class="fa fa-edit fa-lg">&nbsp;</i> <a href="{VIEW.link_edit}">{LANG.edit}</a> - <!-- END: update --> <!-- BEGIN: statics --> <em class="fa fa-bar-chart fa-lg">&nbsp;</em><a href="{VIEW.link_statics}">{LANG.statics}</a> - <!-- END: statics --> <em class="fa fa-trash-o fa-lg">&nbsp;</em> <a href="{VIEW.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);">{LANG.delete}</a>
                    </td>
                </tr>
                <tr>
                    <td colspan="7">
                        <ul class="list-inline help-block">
                            <li class="pointer" data-toggle="tooltip" data-original-title="{LANG.creator}"><em class="fa fa-user">&nbsp;</em>{VIEW.creator}</li>
                            <li class="pointer" data-toggle="tooltip" data-original-title="{LANG.addtime}"><em class="fa fa-clock-o">&nbsp;</em>{VIEW.addtime}</li>
                        </ul>
                    </td>
                </tr>
                <!-- END: loop -->
